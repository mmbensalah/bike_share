class ConditionsDashboardController < ApplicationController
  ...
  def index
    ...
    @rides_ten_degrees_average_1 = format_array(Condition.average_rides_ten_degrees(90, 99))
    @rides_ten_degrees_average_2 = format_array(Condition.average_rides_ten_degrees(80, 89))
    @rides_ten_degrees_average_3 = format_array(Condition.average_rides_ten_degrees(70, 79))
    @rides_ten_degrees_average_4 = format_array(Condition.average_rides_ten_degrees(60, 69))
    ...
    @rides_precipitation_average_1 = format_array(Condition.average_rides_precipitation(0, 0.5))
    @rides_precipitation_average_2 = format_array(Condition.average_rides_precipitation(0.6, 1.0))
    ...
    @rides_mean_wind_speed_average_1 = format_array(Condition.average_rides_wind_speed(0, 4))
    @rides_mean_wind_speed_average_2 = format_array(Condition.average_rides_wind_speed(5, 9))
    ...
    @rides_mean_visibility_average_1 = format_array(Condition.average_rides_visibility(10, 14))
    @rides_mean_visibility_average_2 = format_array(Condition.average_rides_visibility(15, 19))
  end
