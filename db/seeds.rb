...
Item.create(title: "Streamers", price: "5.00", image: 'bike_gear.jpg', description: 'Make your bike looke cool.', status: 0)
Item.create(title: "Water Bottle Holder", price: "6.99", image: 'bike_gear.jpg', description: 'Have a place to hold your water.', status: 0)
Item.create(title: "Lights", price: "25.00", image: 'bike_gear.jpg', description: 'Set of 2. Make sure people see you!', status: 0)
Item.create(title: "Pump", price: "7.00", image: 'bike_shoe.jpg', description: 'Pump up your tires.', status: 0)
Item.create(title: "More Stuff", price: "100.00", image: 'bike_shoe.jpg', description: 'You can always use more stuff', status: 0)
